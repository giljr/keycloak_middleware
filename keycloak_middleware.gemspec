...
Gem::Specification.new do |spec|
  ...
  spec.homepage = "https://github.com/giljr/rails_gems_keycloak_middleware"
  spec.license = "MIT"
  spec.required_ruby_version = ">= 3.1.0"

  spec.metadata["allowed_push_host"] = "https://github.com/giljr/rails_gems_keycloak_middleware"

  spec.metadata["homepage_uri"] = spec.homepage
  spec.metadata["source_code_uri"] = "https://github.com/giljr/rails_gems_keycloak_middleware"
  spec.metadata["changelog_uri"] = "https://github.com/giljr/rails_gems_keycloak_middleware/blob/master/CHANGELOG.md"
